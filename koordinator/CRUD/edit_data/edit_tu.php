...
===================== */
if (!isset($_GET['id_tu'])) {
    header("Location: ../../koordinator/transaksi_ujian.php");
    exit;
}
...
/* =====================
   TEMPLATE
===================== */
include __DIR__ . '/../../koordinator/includes/header.php';
include __DIR__ . '/../../koordinator/includes/navbar.php';
include __DIR__ . '/../../koordinator/includes/sidebar_koordinator.php';
?>
            ...
            <div class="card-body">
                ...
                <form method="POST">
                    ...
                    <div class="text-right">
                        <a href="../../koordinator/transaksi_ujian.php" class="btn btn-secondary">Batal</a>
...
<?php include __DIR__ . '/../../koordinator/includes/footer.php'; ?>