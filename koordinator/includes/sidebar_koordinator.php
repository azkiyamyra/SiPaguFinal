    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown <?= $is_upload_page ? 'active' : ''; ?>">
                ...
                <ul class="dropdown-menu">
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'upload_panitia.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>koordinator/upload_data/upload_panitia.php">Upload Data Panitia</a>
                    </li>
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'upload_tu.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>koordinator/upload_data/upload_tu.php">Upload Transaksi Ujian</a>
                    </li>
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'upload_tpata.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>koordinator/upload_data/upload_tpata.php">Upload Panitia PA/TA</a>
                    </li>
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'upload_jadwal.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>koordinator/upload_data/upload_jadwal.php">Upload Jadwal</a>
                    </li>
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'upload_honor_dosen.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>koordinator/upload_data/upload_honor_dosen.php">Upload Honor Dosen</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="dropdown <?= in_array(basename($_SERVER['PHP_SELF']), 
                ['data_koordinator.php', 'data_jadwal.php', 'data_koordinator.php', 'data_panitia.php', 
                ...
                <ul class="dropdown-menu">
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'data_koordinator.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>koordinator/master_data/data_admin.php">Data Admin</a>
                    </li>
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'data_staff.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>koordinator/master_data/data_staff.php">Data Staff</a>
                    </li>
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'data_koordinator.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>koordinator/master_data/data_koordinator.php">Data Koordinator</a>
                    </li>
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'data_jadwal.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>koordinator/master_data/data_jadwal.php">Data Jadwal</a>
                    </li>
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'data_panitia.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>koordinator/master_data/data_panitia.php">Data Panitia</a>
                    </li>
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'data_thd.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>koordinator/master_data/data_thd.php">Data Honor Dosen</a>
                    </li>
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'data_tpata.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>koordinator/master_data/data_tpata.php">Data PA/TA</a>
                    </li>
                    <li class="<?= basename($_SERVER['PHP_SELF']) === 'data_tu.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="<?= BASE_URL ?>koordinator/master_data/data_tu.php">Data Transaksi Ujian</a>
                    </li>
                </ul>
            </li>
...
// Pola ini aman: jika sidebar_koordinator.php di-include sebelum
