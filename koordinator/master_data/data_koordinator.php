...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'edit') {
    ...
    if ($result) {
        $_SESSION['success_message'] = "Data koordinator berhasil diupdate!";
    } else {
...
<!-- Modal Form Edit Koordinator (Hanya untuk Edit) -->
<div class="modal fade" id="koordinatorModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">Edit Koordinator</h5>
